...
interface VehicleTransferModalSuccessProps {
  isOpen: boolean;
  onClose: () => void;
  title: string;
    ...
    <div className="flex">
      ...
      <div className="flex-1 pb-8">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          {step.description} {step.id == '3' && (<a href='https://stellar.expert/explorer/testnet/tx/2433902132072448' target="_blank" className='underline'>View on Stellar Expert</a>)}
        </p>
        <p>
...
export const VehicleTransferModalSuccess: React.FC<VehicleTransferModalSuccessProps> = ({
  isOpen,
  onClose,
}) => {
  return (
...
export default VehicleTransferModalSuccess;